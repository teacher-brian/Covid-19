...
files <- list.files(path = "./COVID-19/csse_covid-19_data/csse_covid-19_daily_reports_us")

'''
The following are a few lines from 3 different csv files with daily data.

check readme from: https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data
